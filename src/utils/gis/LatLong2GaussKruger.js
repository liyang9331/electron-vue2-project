...
export default function (declare) {
    ...
    // 定义坐标系参数
    // const wgs84 = '+proj=longlat +datum=WGS84 +no_defs';  // WGS84坐标系
    // const cgcs2000 = '+proj=tmerc +lat_0=0 +lon_0=105 +k=1 +x_0=500000 +y_0=0 +ellps=GRS80 +units=m +no_defs';  // CGCS2000坐标系
    // // 使用 proj4 进行坐标转换
    // const cgcs2000Coords = proj4(wgs84, cgcs2000, [longitude, latitude]);
    // // console.log(cgcs2000Coords)
